var iFileName = "Race - Variant Satyr [DanDWiki].js";

RequiredSheetVersion(13);
// This file adds the Variant Satyr from DanDWiki. (https://www.dandwiki.com/wiki/Satyr,_Variant_(5e_Race))
...
RaceList["pipes satyr"] = {
	...
	trait : "Pipes Satyr (+2 Charisma, +1 Dexterity)"+
		...
		"\n \u2022 Pipes: I can use my Panpipes as an Arcane Focus. I know the Vicious Mockery cantrip. At 3rd level, I can cast Entangle. At 5th level, Suggestion. I can cast each without using a spell slot once per long rest. Charisma is my spellcasting ability for these."+
...
Pipes. You can use panpipes (that you begin play with) as an arcane focus to cast spells. You know the vicious mockery cantrip. Once you reach 3rd level, you can cast entangle with this trait, and starting at 5th level, you can also cast suggestion with it. Once you cast a spell with this trait, you can't do so again until you finish a long rest. Charisma is your spellcasting ability for these spells.
